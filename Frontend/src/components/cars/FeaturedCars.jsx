        ...
        <section className='py-20 bg-gray-50'>
            <div className='container px-4 2xl:px-20 mx-auto'>
                ...
                <div className='flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10'>
                    <div>
                        <p className='text-lime-900 text-sm font-semibold tracking-widest uppercase mb-2'>Our Fleet</p>
                        <h2 className='text-3xl sm:text-4xl font-bold text-gray-900'>Featured Cars</h2>
                        <p className='text-gray-500 mt-2 max-w-md'>Handpicked rides for every occasion — from city commutes to weekend escapes.</p>
                    </div>
                    <button
                    ...
                    {filtered.map(car => (
                        ...
                        >
                            ...
                            <div className='relative overflow-hidden h-48'>
                                ...
                                >
                                    <svg className={`w-4 h-4 ${wishlist.includes(car.id) ? 'text-red-500' : 'text-gray-400'}`} fill={wishlist.includes(car.id) ? 'currentColor' : 'none'} stroke='currentColor' viewBox='0 0 24 24'>
                            ...
                            <div className='p-4'>
                                <div className='flex items-start justify-between mb-1'>
                                    ...
                                    <div className='text-right'>
                                        <p className='text-lime-900 font-bold text-lg'>₹{car.price}</p>
                                ...
                                <div className='flex items-center gap-2 mb-4'>
                                    ...
                                    <span className='text-xs text-gray-500'>{car.rating} ({car.reviews})</span>
                                </div>
