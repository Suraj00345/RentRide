...
const UserRegister = () => {
  ...
  return (
    <div className="flex md:w-1/2 items-center justify-center bg-gradient-to-b from-[#4490cf]/35 via-white/30 to-[#c8f53f]/35
      px-6 py-12 md:px-12 lg:px-20">
        ...
        <div className="w-full max-w-sm bg-white p-10 rounded-3xl shadow-[0_0_0_1px_rgba(0,0,0,0.06),0_20px_40px_rgba(0,0,0,0.10)]">
          ...
          <h1 className="text-2xl font-bold text-slate-900 mb-1">Your next ride is one signup away</h1>
          <p className="text-sm text-slate-500 mb-8">Sign up to your account to continue</p>
